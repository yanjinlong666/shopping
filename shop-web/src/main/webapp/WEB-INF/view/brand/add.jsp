...
<fieldset>
	...
	<form class="form-horizontal" id="productForm" action="<%=request.getContextPath()%>/brand/addBrand.jhtml"
		  method="post">
		<div class="form-group">
			<label for="brandName" class="col-md-2 control-label">品牌名字:</label>
			<div class="col-md-3">
				<input type="text" class="form-control" name="brandName" placeholder="品牌名字">
			</div>
		</div>
		<div class="row">
